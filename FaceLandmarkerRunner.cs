...
public class FaceLandmarkerRunner : VisionTaskApiRunner<FaceLandmarker>
{
    ...
    public UnityEvent<FaceLandmarkerResult> onFaceDataOutput;

    private FaceLandmarkerResult safeResult;
    ...
    private void Update()
    {
        if (isResultReady)
        {
            onFaceDataOutput?.Invoke(safeResult);
            isResultReady = false;
        }
    }
    ...
    var options = config.GetFaceLandmarkerOptions(
        ...
        ? OnFaceLandmarkDetectionOutput : null);
    ...
    while (true)
    {
        ...
        case Tasks.Vision.Core.RunningMode.IMAGE:
            ...
            safeResult = result; isResultReady = true;
            }
            else if (_faceLandmarkerResultAnnotationController != null)
